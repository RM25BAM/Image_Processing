# Project Name: **Image Statistical Analysis and Contrast Enhancement**

## Introduction

This project includes a set of Python functions for performing statistical analysis and contrast enhancement of grayscale images. The project covers:

- Statistical evaluation of an image (min, max, mean, standard deviation, variance, and SNR)
- Image histogram evaluation and plotting
- Histogram equalization for contrast enhancement
- Linear contrast correction for contrast enhancement
